// A server runing on client to retrieve data
// Adopted from https://blog.bitsrc.io/building-and-scaling-iot-solutions-with-microsoft-azure-a9d999df4b8
...
server.get("/getdevices", async (req, res) => {
    await registry.list(function(err, devices){
        if (err) {
            ...
            console.log("MyNodeDevice:", devices);
            res.send(devices);
        }
    });
});
